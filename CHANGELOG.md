...
### Added
- Add ability to mint and and watch (via `wallet_watchAsset`) multiple ERC20 tokens. ([#259](https://github.com/MetaMask/test-dapp/pull/259))
- Add malicious `setApprovalForAll` button testing blockaid/ppom module. ([#258](https://github.com/MetaMask/test-dapp/pull/258))

### Fixed
- Fix issue where chainId and networkId were represented as interchangeable ([#256](https://github.com/MetaMask/test-dapp/pull/256))
- Fix issue where legacy eth send transactions did not have the correct gasLimit value ([#257](https://github.com/MetaMask/test-dapp/pull/257))
...
[7.1.0]: https://github.com/MetaMask/test-dapp/compare/v7.1.0...v7.2.0
