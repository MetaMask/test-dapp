...
### Changed
- Change all instances of the term `collectible` to `NFT` ([#237](https://github.com/MetaMask/test-dapp/pull/237))
...
[Unreleased]: https://github.com/MetaMask/test-dapp/compare/v6.3.0...HEAD
[6.3.0]: https://github.com/MetaMask/test-dapp/compare/v6.2.0...v6.3.0
